            ...
            <div id="agregar-administrativo-body" class="modal-body">
                <form id="frm_agregar_administrativo" method="post">
                    ...
                    <div class="form-group row">
                        <label for="ci" class="col-md-8 col-form-label">CI: </label>
                    ...
                    <div class="form-group m-t-10 row">
                        <label for="paterno" class="col-md-12 col-form-label">Paterno: </label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <label for="nacimiento" class="col-md-6 col-form-label">Fecha Nacimiento: </label>
                    ...
                    <div class="form-group row">
                        <label for="domicilio" class="col-md-12 col-form-label">Dirección: </label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <label for="cargo" class="col-md-6 col-form-label">Cargo: </label>
                        <label for="gestion_ingreso" class="col-md-6 col-form-label">Gestion ingreso: </label>
                        <div class="col-md-6">
                            <input type="text" name="cargo" id="cargo" class="form-control" placeholder="Ingrese cargo...">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 text-right">
                            ...
                            <button type="submit" id="btn-guardar-dia-festivo" class="btn btn-primary">Agregar</button>
                        </div>
                    </div>
                </form>
            </div>
