                ...
                <div id="page-content">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div id="demo-panel-network" class="panel">
                                ...
                                <div id="morris-chart-network" style="height: 200px"></div>
                                    ...
                                    <div class="row pad-top">
                                        <div class="col-sm-8">
                                            <div class="media-body pad-lft">
                                                <div class="pad-btm">
                                                    <h5 class="text-uppercase text-main mar-no">Today Tips</h5>
                                                    <small>A wonderful serenity has taken possession of my entire soul.</small>
                                                </div>
                                                <div class="clearfix">
                                                ...
                                                <div class="progress progress-xs">
                                                    <div class="progress-bar progress-bar-dark" style="width: 75%">
                                        ...
                                        <div class="col-sm-4 text-right text-main">
                                            <h5 class="text-uppercase">Bandwidth Usage</h5>
                                            <span class="text-3x text-thin">75.9</span>
                                            <span class="text-bold">Mbps</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="panel">
                                <div class="panel-body text-center clearfix">
                                    ...
                                    <div class="col-sm-8">
                                        <button class="btn btn-warning mar-ver">View Details</button>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            ...
                            <div class="panel">
                                <div class="pad-all">
                                    <p class="text-lg text-semibold text-main"><i class="demo-pli-check icon-fw"></i> Task Progress</p>
                                    <p class="mar-no">
                                ...
                                <div class="pad-all">
                                    ...
                                    <div class="progress progress-md">
                                        <div style="width: 55%" class="progress-bar progress-bar-danger">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="panel media middle pad-all">
                                ...
                                <div class="media-body">
                                    <p class="text-2x mar-no text-semibold text-main">241</p>
                            ...
                            <div class="panel media middle pad-all">
                                ...
                                <div class="media-body">
                                    <p class="text-2x mar-no text-semibold text-main">498</p>
                                    <p class="text-muted mar-no">New Comments</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="panel panel-trans">
                                <div class="panel-heading">
                                    <div class="panel-control">
                                        <a title="" data-html="true" data-container="body" data-original-title="&lt;p class='h4 text-semibold'&gt;Information&lt;/p&gt;&lt;p style='width:150px'&gt;This is an information bubble to help the user.&lt;/p&gt;" href="index.html#" class="demo-psi-information icon-lg icon-fw unselectable text-info add-tooltip"></a>
                                    </div>
                                ...
                                <div class="bord-top">
                                    <ul class="list-group bg-trans bord-no">
                                        <li class="list-group-item list-item-sm">
                                            ...
                                            <div class="media-body">
                                                <a href="index.html#" class="btn-link text-semibold">Facebook</a>
                                            </div>
                                        </li>
                                        <li class="list-group-item list-item-sm">
                                            <div class="media-left">
                                            ...
                                            <div class="media-body">
                                                <a href="index.html#" class="btn-link text-semibold">@RalphWe</a>
                                                <br />
                                                Design my themes with <a href="index.html#" class="btn-link text-bold">#Bootstrap</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                                            </div>
                                        </li>
                                        <li class="list-group-item list-item-sm">
                                            <div class="media-left">
                                            ...
                                            <div class="media-body">
                                                <a href="index.html#" class="btn-link text-semibold">Ralphz</a>
                                            </div>
                                        </li>
                                        <li class="list-group-item list-item-sm">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link"> Order #53431</a></td>
                                                    <td>Steve N. Horton</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 22, 2014</span>
                                                    </td>
                                                    <td>$45.00</td>
                                                ...
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link"> Order #53432</a></td>
                                                    <td>Charles S Boyle</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 24, 2014</span>
                                                    </td>
                                                    <td>$245.30</td>
                                                    <td class="text-center">
                                                ...
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link"> Order #53433</a></td>
                                                    <td>Lucy Doe</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 24, 2014</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link"> Order #53434</a></td>
                                                    <td>Teresa L. Doe</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 15, 2014</span>
                                                    </td>
                                                    <td>$77.99</td>
                                                    <td class="text-center">
                                                        <div class="label label-table label-info">Shipped</div>
                                                ...
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link"> Order #53435</a></td>
                                                    <td>Teresa L. Doe</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 12, 2014</span>
                                                    </td>
                                                    <td>$18.00</td>
                                                    <td class="text-center">
                                                        <div class="label label-table label-success">Paid</div>
                                                ...
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link">Order #53437</a></td>
                                                    <td>Charles S Boyle</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 17, 2014</span>
                                                    </td>
                                                    <td>$658.00</td>
                                                    <td class="text-center">
                                                ...
                                                <tr>
                                                    <td><a href="index.html#" class="btn-link">Order #536584</a></td>
                                                    <td>Scott S. Calabrese</td>
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-clock-o"></i> Oct 19, 2014</span>
                                                    </td>
                                                    <td>$45.58</td>
                                                    <td class="text-center">
                    ...
                    <div class="nano">
                        <div class="nano-content">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li class="active">
                                    <a href="index.html#demo-asd-tab-1" data-toggle="tab">
                                        <i class="demo-pli-speech-bubble-7 icon-lg"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="index.html#demo-asd-tab-2" data-toggle="tab"> <i class="demo-pli-information icon-lg icon-fw"></i> Report </a>
                                </li>
                                <li>
                                    <a href="index.html#demo-asd-tab-3" data-toggle="tab"> <i class="demo-pli-wrench icon-lg icon-fw"></i> Settings </a>
                                </li>
                            </ul>
                            <!--================================-->
                            <!--End nav tabs-->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="demo-asd-tab-1">
                                    <p class="pad-all text-main text-sm text-uppercase text-bold"><span class="pull-right badge badge-warning">3</span> Family</p>
                                    ...
                                    <hr />
                                    <p class="pad-all text-main text-sm text-uppercase text-bold"><span class="pull-right badge badge-success">Offline</span> Friends</p>

                                    <!--Works-->
                                    <div class="list-group bg-trans">
                                        <a href="index.html#" class="list-group-item"> <span class="badge badge-purple badge-icon badge-fw pull-left"></span> Joey K. Greyson </a>
                                        <a href="index.html#" class="list-group-item"> <span class="badge badge-info badge-icon badge-fw pull-left"></span> Andrea Branden </a>
                                        <a href="index.html#" class="list-group-item"> <span class="badge badge-success badge-icon badge-fw pull-left"></span> Johny Juan </a>
                                        <a href="index.html#" class="list-group-item"> <span class="badge badge-danger badge-icon badge-fw pull-left"></span> Susan Sun </a>
                                    </div>
                                    ...
                                    <div class="pad-hor">
                                        <p>Lorem ipsum dolor sit amet, consectetuer <a data-title="45%" class="add-tooltip text-semibold text-main" href="index.html#">adipiscing elit</a>, sed diam nonummy nibh. Lorem ipsum dolor sit amet.</p>
                                ...
                                <div class="tab-pane fade" id="demo-asd-tab-2">
                                    ...
                                    <!--Simple Menu-->
                                    <div class="list-group bg-trans">
                                        <a href="index.html#" class="list-group-item"><i class="demo-pli-information icon-lg icon-fw"></i> Service Information</a>
                                        <a href="index.html#" class="list-group-item"><i class="demo-pli-mine icon-lg icon-fw"></i> Usage Profile</a>
                                        <a href="index.html#" class="list-group-item"><span class="label label-info pull-right">New</span><i class="demo-pli-credit-card-2 icon-lg icon-fw"></i> Payment Options</a>
                                        <a href="index.html#" class="list-group-item"><i class="demo-pli-support icon-lg icon-fw"></i> Message Center</a>
                                    </div>
